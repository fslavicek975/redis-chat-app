...
const PreferencesTab = () => {
  ...
  return (
    <div className="flex flex-wrap gap-2 px-1 md:px-2">
      ...
      >
        <SunIcon className="size-[1.2] text-muted-foreground" />
      </Button>
      <Button
        variant={"outline"}
        size={"icon"}
      ...
      >
        <MoonIcon className="size-[1.2] text-muted-foreground" />
      </Button>
      <Button
        variant={"outline"}
        size={"icon"}
      ...
      >
        {soundEnabled ? (
          <Volume2 className="size-[1.2] text-muted-foreground" />
        ) : (
          <VolumeX className="size-[1.2] text-muted-foreground" />
        )}
      </Button>
    </div>
  );
