    ...
    <div className="flex h-screen w-full">
      ...
      >
        <img
          src="/redis-logo.svg"
          alt="Redis Logo"
          className="absolute -left1/4 opacity-25 -bottom-52 lg:scale-125 xl:scale-100 scale-[2]
        ...
        <div className="flex flex-col gap-2 px-4 xl:ml-40 text-center md:text-start font-semibold">
          <Image
            ...
            width={763}
            height={173}
            className="mt-29 w-[420px] z-0 pointer-events-none select-none"
          />
      ...
      <div className="flex-1 relative overflow-hidden just justify-center items-center hidden md:flex">
        <Image
          src={"/hero-right.png"}
          alt="Hero Image"
          fill
